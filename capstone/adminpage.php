...
<html lang="en">
  ...
  <body>
    ...
    <link href="./adminpage-headerbar.css" rel="stylesheet" />
    <!--Header Bar-->
    <div class="home-container">
        ...
        <header data-role="Header" class="home-header">
          ...
          <div class="popup" id="popup-id">
              <button class="logout-popup" id="logout-popup-id" >Log out?</button>
            </div>
        </header>
    ...
    <link href="./adminpage-dashboard.css" rel="stylesheet" />

    <div class="adminpage-container">
      
    
    <div class="dashboard-sidebar" style="background-color: red;height: 35vh; width: 250px; display: flex; flex-direction: column;">
      <button class = "sidebar-buttons" id="buttons-orders" style="margin-top: 50px;">Orders</button>
      <button class = "sidebar-buttons" id="buttons-offers">Offers</button>
      <button class = "sidebar-buttons" id="buttons-products" style="background-color: #B6FFFD;">Products</button>
    </div>

    <div class="dashboard-products" style="overflow: auto;">
      <p>
        asdsad
      </p>
    </div>
